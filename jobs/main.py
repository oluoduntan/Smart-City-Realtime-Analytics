...
KAFKA_BOOTSTRAP_SERVERS = os.getenv('KAFKA_BOOTSRTAP_SERVERS', 'localhost:9092')
...
def generate_gps_data(device_id, timestamp, vehicle_type='ptivate'):
    return {
        'id': uuid.uuid4(),
        'deviceId': device_id,
        'timestamp': timestamp,
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey(producer, 'vehicle-Olu')
